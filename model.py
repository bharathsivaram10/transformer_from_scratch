...
class LayerNormalization(nn.Module):
    ...
    def __init__(self, features: int, eps: float = 10**-6) -> None:
        super().__init__()
        self.eps = eps
        self.alpha = nn.Parameter(torch.ones(features)) # Mulitplied
...
class EncoderBlock(nn.Module):
    ...
    def __init__(self, features, self_attention_block: MultiHeadAttentionBlock, feed_forward: FeedForwardBlock, dropout: float) -> None:
        super().__init__()
...
class DecoderBlock(nn.Module):
    ...
    def __init__(self, features, self_attention_block: MultiHeadAttentionBlock, cross_attention_block: MultiHeadAttentionBlock, ff_block : FeedForwardBlock, dropout: nn.Dropout):
        super().__init__()
        self.self_attention_block = self_attention_block
